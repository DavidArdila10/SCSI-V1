              ...
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <div className="me-3" style={{ marginBottom: "70px" }}>
                    <div className="mb-2">
                    <Link to={"/writer/sow/create"} className="btn btn-primary d-flex align-items-center">
                <span className="material-symbols-outlined">add_circle</span>
                New
                </Link>

                <Link to={"/writer/sow/kanban"} className="btn btn-success d-flex align-items-center">
                      ...
                      {loading ? (
                        ...
                        dataToDisplay.map((item) => (
                          <tr key={item.ticket_sow}>
                            ...
                            <td>
                              <Link to={`/writer/sow/details/${item.ticket_sow}`} className="btn">
